...
import {IconButton, MenuHandler,MenuList} from "@material-tailwind/react";
 ...
 const style = {
  ...
  return (
    ...
    <div className="flex justify-end -mt-15 ">
      <Button onClick={handleOpen} className="shadow-lg rounded"><GroupAddIcon/></Button>
    </div>
     <TableContainer component={Paper} className='-mt-9 shadow-2xl'>
      <Table sx={{ minWidth: 600 }} size="small" aria-label="a dense table" id="stsTokenDisplay">
        <TableHead>
          <TableRow>
